...
class MoeMusicConfigTest {
    ...
    fun `config normalization clamps and normalizes values`() {
        ...
        assertEquals(5, normalized.permissions.submit)
        assertEquals(5, normalized.permissions.queueControl)
        assertEquals(5, normalized.permissions.vote)
        assertEquals(0, normalized.permissions.playbackControl)
        assertEquals(5, normalized.permissions.configReload)
